...
class PredictFormAdmin extends StatefulWidget {
  const PredictFormAdmin({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PredictFormAdminState createState() => _PredictFormAdminState();
}

class _PredictFormAdminState extends State<PredictFormAdmin> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          ...
          context,
          MaterialPageRoute(
            builder: (context) => DetailAdminPage(recordId: recordId!),
          ),
        );
